            ...
            <div key={vi} className="card space-y-3">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={e => setVehicle(vi, { transport_company_id: Number(e.target.value) || undefined, driver_id: undefined, truck_id: undefined })}
                >
                  <option value="">Seleccionar</option>
                  {transporte?.empresas.map(emp => <option key={emp.id} value={emp.id}>{emp.name}</option>)}
                </select>
              </div>
              ...
              <div>
                ...
                {v.transport_company_id && assignments.length === 0 && (
                  <p className="text-xs text-amber-600 mt-1">Sin conductores asignados a esta empresa.</p>
                )}
              </div>
